...
for each row
update orders set order_amt=(select unitprice from items where item_id=NEW.item_id)*NEW.qty;

-- check trigger

INSERT INTO Orders VALUES
(007, "2020-12-25", 0003, 1000);

INSERT INTO OrderItems VALUES 
(007, 0003, 5); -- This will automatically update the Orders Table also
